...
def pwa_manifest():
    return FileResponse(AQUI / "manifest.json", media_type="application/manifest+json")


@app.get("/sw.js")
def pwa_sw():
    return FileResponse(
        AQUI / "sw.js", media_type="application/javascript",
...
def pwa_icon_192():
    return FileResponse(AQUI / "icon-192.png", media_type="image/png")


@app.get("/icon-512.png")
def pwa_icon_512():
    return FileResponse(AQUI / "icon-512.png", media_type="image/png")
