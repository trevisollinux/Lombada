...
const messages: Record<Locale, Record<ShelfTextKey, string>> = {
  ...
  es: {
    ...
    list: 'Lista',
    spines: 'Lomos',
    loading: 'Cargando tu estantería…',
    error: 'No se pudo cargar tu estantería.',
    empty_title: 'Tu estantería aún está vacía',
    empty_copy: 'Registra una lectura para empezar a construir tu biblioteca personal.',
    empty_filtered: 'Ninguna lectura coincide con este filtro.',
    register: 'Buscar un libro',
    books_count: 'libros',
    status: 'Estado',
    rating: 'Tu nota',
    no_rating: 'sin nota',
    ...
    pages: 'páginas',
    review: 'Reseña',
    private_review: 'privada',
    public_review: 'pública',
    spoiler: 'contiene spoiler',
    owned: 'en tu colección',
    wanted: 'edición deseada',
    open_detail: 'Abrir detalles',
    close_detail: 'Cerrar detalles',
    open_legacy: 'Abrir en la app actual',
    no_review: 'No hay reseña registrada para esta lectura.',
    edit_reading: 'Editar lectura',
    reading_date: 'Cuándo lo leíste',
    reading_date_placeholder: 'ej.: julio de 2026',
    review_placeholder: 'Escribe tus impresiones sobre la lectura…',
    make_public: 'Hacer pública la reseña',
    make_public_hint: 'La reseña podrá aparecer en tu perfil y en la comunidad.',
    mark_spoiler: 'Esta reseña contiene spoiler',
    mark_spoiler_hint: 'El contenido quedará protegido tras un aviso para otros lectores.',
    save_changes: 'Guardar cambios',
    saving: 'Guardando…',
    cancel: 'Cancelar',
    remove_reading: 'Quitar de la estantería',
    remove_hint: 'La lectura y sus entradas de diario vinculadas se eliminarán.',
    remove_confirmation: 'Esta acción es permanente. Confirma para quitar la lectura y su diario.',
    keep_reading: 'Mantener lectura',
    confirm_remove: 'Confirmar eliminación',
    remove: 'Quitar',
    deleting: 'Quitando…',
    save_error: 'No se pudieron guardar los cambios.',
    delete_error: 'No se pudo quitar la lectura.',
    saved_success: 'Lectura actualizada.',
    deleted_success: 'Lectura quitada de tu estantería.',
  },
}
