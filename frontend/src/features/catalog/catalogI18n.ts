...
const messages: Record<Locale, Record<CatalogTextKey, string>> = {
  ...
  es: {
    loading: 'Buscando en el catálogo…',
    error: 'No se pudo buscar en el catálogo.',
    no_results: 'No se encontraron libros',
    no_results_copy: 'Prueba con otro título, autor o ISBN.',
    popular_searches: 'Búsquedas populares',
    popular_books: 'Libros destacados',
    results: 'resultados',
    readings: 'lecturas',
    reviews: 'reseñas',
    reading_now: 'leyendo ahora',
    open_work: 'Ver obra y ediciones',
    ...
    pages: 'páginas',
    isbn: 'ISBN',
    unknown_edition: 'Detalles de la edición no disponibles',
    no_editions: 'No se encontraron ediciones',
    no_editions_copy: 'La obra existe, pero aún no hay una edición disponible para registrar.',
    register: 'Registrar lectura',
    register_title: 'Añadir a la estantería',
    status: 'Estado',
    rating: 'Nota',
    no_rating: 'sin nota',
    ...
    review: 'Reseña',
    review_placeholder: 'Podrás editarla o ampliarla después desde tu estantería.',
    make_public: 'Hacer pública la reseña',
    mark_spoiler: 'Contiene spoilers',
    own_edition: 'Tengo esta edición',
    want_edition: 'Quiero esta edición',
    save: 'Añadir a la estantería',
    saving: 'Añadiendo…',
    cancel: 'Cancelar',
    registered: 'Lectura añadida',
    registered_copy: 'La edición se registró en tu estantería.',
    go_shelf: 'Abrir estantería',
    duplicate: 'Esta edición ya está en tu estantería.',
    save_error: 'No se pudo añadir la lectura.',
    selected: 'seleccionada',
    already_read: 'ya leída',
    owned: 'en la colección',
    wanted: 'deseada',
    average: 'media',
    edition_readings: 'lecturas de esta edición',
  },
}
