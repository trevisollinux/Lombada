...
import { ReaderSuggestions, ReadingNowRail } from './FeedDiscoveryPanels'
import { FeedItemCard } from './FeedItemCard'
import { feedText } from './feedI18n'

type FeedTab = 'following' | 'discover'

/* Corpo da comunidade (stories em destaque no topo + abas Seguindo/Descobrir +
   stream de críticas). Usado tanto na rota /feed quanto embutido no Explorar. */
export function CommunityFeed() {
  ...
  return (
    <div className="community-feed">
      {/* stories em destaque no topo, antes das abas */}
      {status === 'ready' && <ReadingNowRail items={readingNow} locale={locale} />}
