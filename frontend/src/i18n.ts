...
const messages: Record<Locale, Record<TranslationKey, string>> = {
  'pt-BR': {
    ...
    search_copy: 'O novo fluxo de busca vai começar aqui. O shell, a navegação e a sessão já são reais.',
    search_placeholder: 'título, autor ou ISBN…',
    search_button: 'buscar',
    search_preview: 'A busca completa será a próxima grande funcionalidade migrada.',
    feed_eyebrow: 'comunidade',
    feed_title: 'Feed',
    feed_copy: 'Críticas, atividades e pessoas que você acompanha aparecerão aqui.',
    shelf_eyebrow: 'sua biblioteca',
    shelf_title: 'Estante',
    shelf_copy: 'A estante será a primeira área de dados reais migrada depois do shell.',
    diary_eyebrow: 'durante a leitura',
    diary_title: 'Diário',
    diary_copy: 'Progresso, impressões e trechos serão organizados nesta rota.',
    ...
    quick_copy: 'Enquanto o formulário novo não é migrado, você pode abrir a busca ou usar o app atual.',
    quick_register: 'Ir para buscar',
    quick_diary: 'Abrir diário',
    quick_legacy: 'Registrar no app atual',
  ...
  en: {
    ...
    search_copy: 'The new search flow will start here. The shell, navigation and session are already real.',
    search_placeholder: 'title, author or ISBN…',
    search_button: 'search',
    search_preview: 'Full search will be the next major feature migrated.',
    feed_eyebrow: 'community',
    feed_title: 'Feed',
    feed_copy: 'Reviews, activity and people you follow will appear here.',
    shelf_eyebrow: 'your library',
    shelf_title: 'Shelf',
    shelf_copy: 'The shelf will be the first real-data area migrated after the shell.',
    diary_eyebrow: 'while reading',
    diary_title: 'Diary',
    diary_copy: 'Progress, impressions and excerpts will be organized on this route.',
    ...
    quick_copy: 'Until the new form is migrated, open search or use the current app.',
    quick_register: 'Go to search',
    quick_diary: 'Open diary',
    quick_legacy: 'Log in current app',
